...
async def search_videos(
    ...
    """Vector search across online video library"""
    # Force filter to only video type
    payload.types = ["video"]
...
async def list_videos(
    ...
    return await media_service.list_media(session, "video", limit, offset)
...
async def get_video_detail(
    ...
    """Fetch metadata details for a specific online video"""
...
async def stream_video(
    ...
    """Stream original online video media file"""
...
async def ingest_video(
    ...
    """Ingest an online video file into the library"""
    # Force media type to video
